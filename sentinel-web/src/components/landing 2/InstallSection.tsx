 ...
 * Install Section
 * 
 * Shows installation instructions with copy-able code blocks.
 */
...
const codeBlocks = [
    ...
    },
    {
        ...
        code: 'sentinel scan ~/Downloads',
    },
    {
        title: 'Create organization plan',
        code: 'sentinel plan ~/Downloads',
    },
    {
        title: 'Execute plan',
        code: 'sentinel apply task-abc-123',
    },
];
            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <p className="text-lg text-slate-400 max-w-2xl mx-auto">
                        Install Sentinel with pip and start organizing your files immediately.
                    </p>
                </motion.div>
                    ...
                    {codeBlocks.map((block, index) => (
                        ...
                        >
                            <Card variant="standard" className="p-0 overflow-hidden">
                                ...
                                <div className="px-4 py-3 bg-slate-950 font-mono text-sm text-primary">
                                    $ {block.code}
                                </div>
                            </Card>
                        </motion.div>
                ...
                >
                    <p className="text-slate-500 text-sm mb-4">
                        Requires Python 3.11+ and Ollama for AI features
                    </p>
                    <a
