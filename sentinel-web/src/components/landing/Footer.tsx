                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-6 text-[14px]">
                        <a
                            ...
                            className="text-txt-muted hover:text-txt-primary transition-colors flex items-center gap-2"
                        >
                        ...
                        <a href="/dashboard" className="text-txt-muted hover:text-txt-primary transition-colors">
                            Dashboard
                        </a>
                    </div>
                </div>
